    ...
    <div className="bg-white rounded-xl border border-gray-200">
      ...
      <div className="border-t border-gray-100 px-5 py-4 space-y-4">
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="text-sm text-gray-900">New Candidate Applied</div>
            <div className="text-xs text-gray-500">Notify me when a new candidate applies to a posting I manage.</div>
          </div>
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="text-xs text-gray-500">Notify me when an interview is scheduled or updated.</div>
          </div>
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="text-sm text-gray-900">Messages</div>
            <div className="text-xs text-gray-500">Notify me when a candidate completes an assessment.</div>
          </div>
